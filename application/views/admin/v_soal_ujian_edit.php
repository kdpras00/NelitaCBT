                            ...
                            <div class="col-sm-10">
                                <select class="select2 form-control" name="nama_matapelajaran" required="">
                                    ...
                                    <?php foreach($kelas as $a) { ?>
                                      <option value="<?=$a->id_matapelajaran?>" <?php if($s->id_matapelajaran==$a->id_matapelajaran){echo "selected='selected'";} ?>><?= $a->kode_matapelajaran;?> | <?= $a->nama_matapelajaran;?></option>
                                  <?php } ?>
                                </select>
                            ...
                            <div class="col-sm-10">
                                <select class="select2 form-control" name="id_kelas" required="">
                                    ...
                                    <?php foreach($list_kelas as $k) { ?>
                                      <option value="<?=$k->id_kelas?>" <?php if($s->id_kelas==$k->id_kelas){echo "selected='selected'";} ?>><?= $k->nama_kelas;?></option>
                                  <?php } ?>
                                </select>
                            </div>
                        </div>
